...
namespace InspectionValidation.Tests
{
    ...
    public class ValidationMethodsTests
    {
        ...
        public void InspValidation_ValidatePirmTest_NoTaPatiVieta()
        {
            ...
            IList<ISuspInspInfo> susps = InspValidationMethods.ValidatePirm(insp, db);
        ...
        public void InspValidation_ValidateNepirm_PirmKaipNepirm()
        {
            ...
            IList<ISuspInspInfo> susps = InspValidationMethods.ValidateNepirm(insp, db);
        }
        ...
        public void InspValidation_ValidateNepirm_Nerastas()
        {
            ...
            IList<ISuspInspInfo> susps = InspValidationMethods.ValidateNepirm(insp, db);
            Assert.IsTrue(susps.Count == 1);
            Assert.AreEqual<string>("toks įrašas nerastas ir jo duomenys negali būti pakeisti", ((SuspInspInfo)susps[0]).Message);
        }
        ...
        public void InspValidation_ValidateNepirm_VietaDoesntAgree()
        {
            ...
            Assert.IsTrue(susps.Count == 1);
            Assert.AreEqual<string>("neatitinka vietos kodas", ((SuspInspInfo)susps[0]).Message, "siule");

            insp = new Insp(4, "01", 2, 256, 3, 36, 9, "06.4", "428", "829", new DateTime(2017, 9, 12), "GTC", Kelintas.Extra);
            susps = InspValidationMethods.ValidateNepirm(insp, db);
            Assert.IsTrue(susps.Count == 1);
            Assert.AreEqual<string>("neatitinka vietos kodas", ((SuspInspInfo)susps[0]).Message, "kelias");

            insp = new Insp(4, "01", 1, 255, 3, 36, 9, "06.4", "428", "829", new DateTime(2017, 9, 12), "GTC", Kelintas.Extra);
            susps = InspValidationMethods.ValidateNepirm(insp, db);
            Assert.IsTrue(susps.Count == 1);
            Assert.AreEqual<string>("neatitinka vietos kodas", ((SuspInspInfo)susps[0]).Message, "km");

            insp = new Insp(4, "01", 1, 256, 1, 36, 9, "06.4", "428", "829", new DateTime(2017, 9, 12), "GTC", Kelintas.Extra);
            susps = InspValidationMethods.ValidateNepirm(insp, db);
            Assert.IsTrue(susps.Count == 1);
            Assert.AreEqual<string>("neatitinka vietos kodas", ((SuspInspInfo)susps[0]).Message, "pk");

            insp = new Insp(4, "1", 1, 256, 3, 36, 9, "06.4", "428", "829", new DateTime(2017, 9, 12), "GTC", Kelintas.Extra);
            susps = InspValidationMethods.ValidateNepirm(insp, db);
            Assert.IsTrue(susps.Count == 1);
            Assert.AreEqual<string>("neatitinka vietos kodas", ((SuspInspInfo)susps[0]).Message, "linija");

            insp = new Insp(4, "01", 1, 256, 3, 33, 9, "06.4", "428", "829", new DateTime(2017, 9, 12), "GTC", Kelintas.Extra);
            susps = InspValidationMethods.ValidateNepirm(insp, db);
            Assert.IsTrue(susps.Count == 1);
            Assert.AreEqual<string>("neatitinka vietos kodas", ((SuspInspInfo)susps[0]).Message, "m");

            insp = new Insp(4, "23", 1, 15, 3, 33, 9, "06.4", "428", "829", new DateTime(2017, 9, 12), "GTC", Kelintas.Extra);
            susps = InspValidationMethods.ValidateNepirm(insp, db);
            Assert.IsTrue(susps.Count == 1);
            Assert.AreEqual<string>("neatitinka vietos kodas", ((SuspInspInfo)susps[0]).Message, "linija, km, m");
        }
        ...
        public void InspValidation_ValidateNepirm_SkodaiDontAgree()
        {
            ...
            IList<ISuspInspInfo> susps = InspValidationMethods.ValidateNepirm(insp, db);
            Assert.IsTrue(susps.Count == 1);
            Assert.AreEqual<string>("esantis sąlyginis kodas", ((SuspInspInfo)susps[0]).Message.Substring(0, 23));
        }
        ...
        public void InspValidation_ValidateNepirm_AlreadyInspected()
        {
            ...
            Assert.AreEqual<string>("2 tikrinimas jau atliktas", ((SuspInspInfo)susps[0]).Message, "II");
            ...
            Assert.AreEqual<string>("3 tikrinimas jau atliktas", ((SuspInspInfo)susps[0]).Message, "III");
            ...
            Assert.AreEqual<string>("4 tikrinimas jau atliktas", ((SuspInspInfo)susps[0]).Message, "IV");
        ...
        public void InspValidation_ValidateNepirm_FormerIsntDone()
        {
            ...
            susps = InspValidationMethods.ValidateNepirm(insp, db);
            Assert.IsTrue(susps.Count == 1, "2");
            Assert.AreEqual<string>("neatliktas ankstesnis patikrinimas (data1 tuščias)", ((SuspInspInfo)susps[0]).Message, "II");
            ...
            susps = InspValidationMethods.ValidateNepirm(insp, db);
            Assert.IsTrue(susps.Count == 1, "3");
            Assert.AreEqual<string>("neatliktas ankstesnis patikrinimas (data2 tuščias)", ((SuspInspInfo)susps[0]).Message, "III");
            ...
            susps = InspValidationMethods.ValidateNepirm(insp, db);
            Assert.IsTrue(susps.Count == 1, "4");
            Assert.AreEqual<string>("neatliktas ankstesnis patikrinimas (data3 tuščias)", ((SuspInspInfo)susps[0]).Message, "IV");
        }
        ...
        public void InspValidation_ValidateNepirm_LaterIsDone()
        {
            ...
            Assert.AreEqual<string>("įrašyta, kad jau atliktas vėlesnis patikrinimas (data3 netuščias)", ((SuspInspInfo)susps[0]).Message, "II - xoxo");
            ...
            Assert.AreEqual<string>("įrašyta, kad jau atliktas vėlesnis patikrinimas (data3 netuščias)", ((SuspInspInfo)susps[0]).Message, "II - xoxx");
            ...
            Assert.AreEqual<string>("įrašyta, kad jau atliktas vėlesnis patikrinimas (data3 netuščias)", ((SuspInspInfo)susps[1]).Message, "II - ooxo");
            ...
            Assert.AreEqual<string>("įrašyta, kad jau atliktas vėlesnis patikrinimas (data3 netuščias)", ((SuspInspInfo)susps[1]).Message, "II - ooxx");
            ...
            Assert.AreEqual<string>("įrašyta, kad jau atliktas vėlesnis patikrinimas (data4 netuščias)", ((SuspInspInfo)susps[1]).Message, "III - ooox");
            ...
            Assert.AreEqual<string>("įrašyta, kad jau atliktas vėlesnis patikrinimas (data4 netuščias)", ((SuspInspInfo)susps[1]).Message, "III - xoox");
            ...
            Assert.AreEqual<string>("įrašyta, kad jau atliktas vėlesnis patikrinimas (data4 netuščias)", ((SuspInspInfo)susps[0]).Message, "III - xxox");
            ...
            Assert.AreEqual<string>("įrašyta, kad jau atliktas vėlesnis patikrinimas (data4 netuščias)", ((SuspInspInfo)susps[0]).Message, "IV");
        }
        ...
        public void InspValidation_ValidateNepirm_FormerIsLater()
        {
            ...
            Assert.AreEqual<string>("ankstesnis patikrinimas data1 atliktas vėliau", ((SuspInspInfo)susps[0]).Message.Substring(0, 45), "message II");
            ...
            Assert.AreEqual<string>("ankstesnis patikrinimas data2 atliktas vėliau", ((SuspInspInfo)susps[0]).Message.Substring(0, 45), "message III");
            ...
            Assert.AreEqual<string>("ankstesnis patikrinimas data3 atliktas vėliau", ((SuspInspInfo)susps[0]).Message.Substring(0, 45), "message IV");
        }
